...
from . import (index, login, register, admin_home, user_home, users, logout, admin_places)

from . import admin_places
router.include_router(admin_places.admin_router)