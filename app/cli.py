...
def initialize():
    with get_cli_session() as db:
        ...
        places = [
            ...
            Restaurant(name="Linda's Bakery Bakery", location="JFK Quadrangle", description="Freshly baked pastries, salads, breads and natural juices. A campus institution.", latitude=10.63865, longitude=-61.39858, category="JFK", phone="+1868-280-2350"),
        ...
        items = [
            ...
            MenuItem(name="Hola Kola", price=8.0, description="Classic Flavorite fruit lolly in refreshing cola and tropical flavours — a Trini childhood favourite", is_available=True, restaurant_id=pid("Vending Machine (Drinks)")),
            MenuItem(name="Likka Stik", price=12.0, description="Creamy flavoured ice lolly on a stick — smooth, sweet and loved by generations of Trinidadians", is_available=False, restaurant_id=pid("Vending Machine (Drinks)")),
            MenuItem(name="Milkies", price=8.0, description="Soft and creamy milk-based frozen treat — light, smooth and perfect for a quick cool down", is_available=True, restaurant_id=pid("Vending Machine (Drinks)")),
            MenuItem(name="Freezies", price=6.0, description="Colourful fruit flavoured ice in a squeeze tube — the ultimate affordable campus refresher", is_available=True, restaurant_id=pid("Vending Machine (Drinks)")),
            MenuItem(name="Dark N Gold", price=15.0, description="Smooth dark chocolate and golden vanilla ice cream on a stick — a beloved Trini classic", is_available=True, restaurant_id=pid("Vending Machine (Drinks)")),
            MenuItem(name="Double Dark", price=15.0, description="Rich double chocolate ice cream bar for the true chocolate lover — bold, creamy and indulgent", is_available=True, restaurant_id=pid("Vending Machine (Drinks)")),
            MenuItem(name="Nutty Royale Lollie", price=15.0, description="Vanilla ice cream bar coated in a crunchy chocolate and nut shell — an iconic Flavorite treat", is_available=True, restaurant_id=pid("Vending Machine (Drinks)")),
            MenuItem(name="Nutty Royale Cone", price=18.0, description="Crispy waffle cone filled with vanilla ice cream and topped with chocolate and crushed nuts", is_available=False, restaurant_id=pid("Vending Machine (Drinks)")),
            MenuItem(name="Screwball", price=12.0, description="Fruity spiral ice cream in a cup with a bubblegum surprise at the bottom — a fun Trini classic", is_available=False, restaurant_id=pid("Vending Machine (Drinks)")),
            MenuItem(name="Ice Cream Sandwich", price=13.0, description="Creamy vanilla ice cream pressed between two soft chocolate wafer biscuits", is_available=True, restaurant_id=pid("Vending Machine (Drinks)")),
            ...
            # Linda's Bakery
            MenuItem(name="Coconut Bake", price=12.0, description="Traditional coconut-flavoured baked bread roll", is_available=True, restaurant_id=pid("Linda's Bakery")),
            MenuItem(name="Fruit Salad", price=20.0, description="Fresh seasonal fruit salad with a squeeze of lime", is_available=True, restaurant_id=pid("Linda's Bakery")),
            MenuItem(name="Fresh Carrot Juice", price=15.0, description="Freshly blended carrot juice", is_available=True, restaurant_id=pid("Linda's Bakery")),
            # The Gourmet Pot
