...
def initialize():
    with get_cli_session() as db:
        ...
        places = [
            Restaurant(name="Dee & Vees", location="School of Education Compound", description="Authentic Creole food vendor serving hearty local Trinidadian meals.", latitude=10.6418, longitude=-61.3963, category="School of Education"),
            Restaurant(name="La Bloom Café", location="Centre for Language and Learning", description="Coffee, drinks and a variety of food items. A great spot to recharge between classes.", latitude=10.6427, longitude=-61.3978, category="Language & Learning"),
            Restaurant(name="Vending Machine (Ice Cream)", location="Student Activity Centre (SAC) Ground Floor", description="Ice cream and lollies vending machine. Quick sweet treats between classes.", latitude=10.6424, longitude=-61.3990, category="SAC"),
            Restaurant(name="Caribbean Natural Juices", location="Student Activity Centre (SAC) Ground Floor", description="Fresh squeezed juices and natural beverages made from local fruits.", latitude=10.6424, longitude=-61.3991, category="SAC"),
            Restaurant(name="Celes and Son Home-style Cooking", location="Student Activity Centre (SAC) Ground Floor", description="Creole home-style cooking with hearty local dishes at student-friendly prices.", latitude=10.6423, longitude=-61.3992, category="SAC"),
            Restaurant(name="Maureen's Cuisine", location="Student Activity Centre (SAC) Ground Floor", description="Serving pies, sandwiches and snacks. A popular stop for a quick bite.", latitude=10.6423, longitude=-61.3993, category="SAC"),
            Restaurant(name="Oriental Cuisine", location="Student Activity Centre (SAC) Ground Floor", description="Chinese food served fresh daily. Popular for fried rice, chow mein and more.", latitude=10.6422, longitude=-61.3991, category="SAC"),
            Restaurant(name="Lee's Doubles", location="Student Activity Centre (SAC) Ground Floor", description="Classic Trini doubles and street food. A campus favourite for breakfast and lunch.", latitude=10.6422, longitude=-61.3990, category="SAC"),
            Restaurant(name="Juman's Roti Shop", location="Student Activity Centre (SAC) 2nd Floor", description="Authentic Trini roti — dhalpuri and paratha with a variety of curries.", latitude=10.6424, longitude=-61.3989, category="SAC"),
            Restaurant(name="Veg & More", location="Close to Student Activity Centre (SAC)", description="Pies, pastries and drinks. Great vegetarian-friendly options on campus.", latitude=10.6421, longitude=-61.3988, category="SAC"),
            Restaurant(name="Mini Mart (SAC)", location="Student Activities Centre", description="Campus convenience store stocking snacks, drinks and everyday essentials.", latitude=10.6423, longitude=-61.3987, category="SAC"),
            Restaurant(name="Mini Mart (SAL Hall)", location="SAL Hall", description="Convenient store near SAL Hall with snacks, beverages and daily necessities.", latitude=10.6432, longitude=-61.3985, category="Halls of Residence"),
            Restaurant(name="Pita Pit", location="JFK Quadrangle", description="Wraps, paninis and pita pockets with fresh fillings. A healthy and tasty choice.", latitude=10.6430, longitude=-61.3999, category="JFK"),
            Restaurant(name="Rituals Coffee House", location="JFK Quadrangle", description="Premium coffee, teas, cold drinks and food items. The campus coffee hotspot.", latitude=10.6431, longitude=-61.4000, category="JFK"),
            Restaurant(name="Linda's", location="JFK Quadrangle", description="Freshly baked pastries, salads, breads and natural juices. A campus institution.", latitude=10.6429, longitude=-61.3998, category="JFK"),
            Restaurant(name="Ave 5055", location="JFK Quadrangle", description="Desserts, sweet treats and indulgent snacks to satisfy your sweet tooth.", latitude=10.6430, longitude=-61.3997, category="JFK"),
            Restaurant(name="The Gourmet Pot", location="Dudley Huggins Building", description="Contemporary cuisine with diverse menu options. Elevated campus dining.", latitude=10.6435, longitude=-61.4008, category="Dudley Huggins"),
            Restaurant(name="KFC", location="JFK Food Court", description="Kentucky Fried Chicken — fries, chicken and combos from the globally loved brand.", latitude=10.6428, longitude=-61.4003, category="JFK Food Court"),
            Restaurant(name="Subway", location="JFK Food Court", description="Sub sandwiches made to order with fresh bread, proteins and toppings.", latitude=10.6428, longitude=-61.4004, category="JFK Food Court"),
            Restaurant(name="Benny's BBQ & Burgers", location="Car Park next to Staff Social Club", description="Burgers and BBQ done right. Smoky flavours with generous portions.", latitude=10.6412, longitude=-61.4010, category="Staff Social Club Area"),
            Restaurant(name="Boba and Brew Café", location="Republic Bank Plaza – UWI", description="Pastries, smoothies and ice cream. A trendy café spot on campus.", latitude=10.6440, longitude=-61.3980, category="Republic Bank Plaza"),
            Restaurant(name="Blue Waters Vending", location="Main Campus & School of Education", description="Blue Waters vending machines offering chilled beverages across campus.", latitude=10.6425, longitude=-61.3975, category="Vending"),
            Restaurant(name="Al Mohammed on the Link Up", location="Teaching and Learning Centre", description="Burgers and sandwiches served near the Teaching and Learning Centre.", latitude=10.6433, longitude=-61.3995, category="Teaching & Learning Centre"),
            Restaurant(name="Snack Machine (Couva)", location="Couva Facilities", description="Snack vending machine at the Couva campus facility.", latitude=10.5890, longitude=-61.4200, category="Couva"),
        ]
